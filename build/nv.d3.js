...
nv.utils.defaultColor = function() {
	...
	return nv.utils.getColor(d3.scale.threshold().range (['#fff7f3', '#fde0dd', '#fcc5c0','#fa9fb5','#f768a1','#dd3497','#ae017e','#7a0177','#49006a']).domain ([66, 121, 165, 203, 246, 472, 505, 671]));
};
...
nv.models.heatMap = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
		...
		, xMetaColorScale2 = nv.utils.defaultColor()
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var xMetaEnter = xMetas
				...
				.attr("fill", function(d) { return xMetaColorScale2(d); })
            ...
            cellWrap
                .on('mouseover', function(d,i) {
                    ...
                    dispatch.elementMouseover({
                        value: getKeyByValue(uniqueY, iy) + ', ' + getKeyByValue(uniqueX, ix), 
                        series: {
            ...
            allMetaRect
                .on('mouseover', function(d,i) {
                    ...
                    dispatch.elementMouseover({
						...
						value: isColMeta ? 'Year Total' : 'Row meta',
...
nv.models.heatMapChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var yPos = -5;
            if (hasColumnMeta()) {
				//axisX.selectAll('text').style('fill', function(d) { return cellTextColor(cellColor(d)) });
				//axisX.selectAll('text').style('fill', function(d) { if(d.category > 600) { return "white" } else { return "black" } });
				axisX.selectAll('text').filter(function(){ return d3.select(this).text() > 2014 }).style('fill', 'white');
				//axisX.selectAll('text').style('fill', '#a9a8a8');
                axisX.selectAll('text').style('text-anchor', 'middle');
				//axisX.selectAll('text').style('font-weight', 'bold');
